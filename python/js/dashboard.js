		...
		$('.chat-input').keypress(function (ev) {
			...
			if (p == 13) {
				if (chatText == "") {
					...
					$('<li class="clearfix"><div class="chat-avatar"><img class="img-responsive" src="images/photos/user1.png" alt="female"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>Ravi Jaiswal</i><p>' + chatText + '</p></div></div></li>').appendTo('.widget-conversation-list');
					$(this).val('');
